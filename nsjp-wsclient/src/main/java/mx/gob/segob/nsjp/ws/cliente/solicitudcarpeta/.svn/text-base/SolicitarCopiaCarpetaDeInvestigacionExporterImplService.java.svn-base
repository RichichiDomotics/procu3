 ...
 * 2012-01-16T19:57:30.385-06:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "SolicitarCopiaCarpetaDeInvestigacionExporterImplService", 
                  wsdlLocation = "http://localhost:8080/nsjp-web/SolicitarCopiaCarpetaDeInvestigacionExporterImplService?wsdl",
...
public class SolicitarCopiaCarpetaDeInvestigacionExporterImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/nsjp-web/SolicitarCopiaCarpetaDeInvestigacionExporterImplService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SolicitarCopiaCarpetaDeInvestigacionExporterImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/nsjp-web/SolicitarCopiaCarpetaDeInvestigacionExporterImplService?wsdl");
        }
        WSDL_LOCATION = url;
    }
