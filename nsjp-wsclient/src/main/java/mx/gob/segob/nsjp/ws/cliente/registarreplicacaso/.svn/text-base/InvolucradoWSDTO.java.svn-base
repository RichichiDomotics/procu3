    ...
    extends PersonaWSDTO
{
     ...
     * @param aliasInvolucrado el valor aliasInvolucrado a asignar
     */
    public void setAliasInvolucrado(List<String> aliasInvolucrado) {
     ...
     * @param detenciones el valor detenciones a asignar
     */
