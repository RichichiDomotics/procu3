 ...
 * 2012-09-03T17:47:32.435-05:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "EnviarSolicitudServiceExporterImplService", 
                  wsdlLocation = "http://localhost:8080/nsjp-web/EnviarSolicitudServiceExporterImplService?wsdl",
...
public class EnviarSolicitudServiceExporterImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/nsjp-web/EnviarSolicitudServiceExporterImplService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EnviarSolicitudServiceExporterImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/nsjp-web/EnviarSolicitudServiceExporterImplService?wsdl");
        }
        WSDL_LOCATION = url;
    }
