 ...
 * generated in the mx.gob.segob.nsjp.ws.cliente.avidohdelictivo package. 
...
public class ObjectFactory {
    ...
    private final static QName _RecibirAvisoHDelictivoServiceResponse_QNAME = new QName("http://ws.service.nsjp.segob.gob.mx/", "recibirAvisoHDelictivoServiceResponse");
    private final static QName _NSJPNegocioException_QNAME = new QName("http://ws.service.nsjp.segob.gob.mx/", "NSJPNegocioException");
    private final static QName _RecibirAvisoHDelictivoService_QNAME = new QName("http://ws.service.nsjp.segob.gob.mx/", "recibirAvisoHDelictivoService");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mx.gob.segob.nsjp.ws.cliente.avidohdelictivo
     * 
     */
    ...
    /**
     * Create an instance of {@link RecibirAvisoHDelictivoServiceResponse }
     * 
     */
    public RecibirAvisoHDelictivoServiceResponse createRecibirAvisoHDelictivoServiceResponse() {
        return new RecibirAvisoHDelictivoServiceResponse();
    }
    ...
    /**
     * Create an instance of {@link RecibirAvisoHDelictivoService }
     * 
     */
    public RecibirAvisoHDelictivoService createRecibirAvisoHDelictivoService() {
        return new RecibirAvisoHDelictivoService();
    }
    ...
    /**
     * Create an instance of {@link AvisoHechoDelictivoWSDTO }
     * 
     */
    public AvisoHechoDelictivoWSDTO createAvisoHechoDelictivoWSDTO() {
        return new AvisoHechoDelictivoWSDTO();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RecibirAvisoHDelictivoServiceResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.service.nsjp.segob.gob.mx/", name = "recibirAvisoHDelictivoServiceResponse")
    public JAXBElement<RecibirAvisoHDelictivoServiceResponse> createRecibirAvisoHDelictivoServiceResponse(RecibirAvisoHDelictivoServiceResponse value) {
        return new JAXBElement<RecibirAvisoHDelictivoServiceResponse>(_RecibirAvisoHDelictivoServiceResponse_QNAME, RecibirAvisoHDelictivoServiceResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RecibirAvisoHDelictivoService }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.service.nsjp.segob.gob.mx/", name = "recibirAvisoHDelictivoService")
    public JAXBElement<RecibirAvisoHDelictivoService> createRecibirAvisoHDelictivoService(RecibirAvisoHDelictivoService value) {
        return new JAXBElement<RecibirAvisoHDelictivoService>(_RecibirAvisoHDelictivoService_QNAME, RecibirAvisoHDelictivoService.class, null, value);
    }
