    ...
    extends ElementoWSDTO
{
     ...
     * @param correos el valor correos a asignar
     */
    ...
    /**
     * Asigna el valor al campo nombresDemograficos.
     * @param nombresDemograficos el valor nombresDemograficos a asignar
     */
    public void setNombresDemograficos(
            List<NombreDemograficoWSDTO> nombresDemograficos) {
        this.nombresDemograficos = nombresDemograficos;
    }

    /**
     * Asigna el valor al campo telefonos.
     * @param telefonos el valor telefonos a asignar
     */
