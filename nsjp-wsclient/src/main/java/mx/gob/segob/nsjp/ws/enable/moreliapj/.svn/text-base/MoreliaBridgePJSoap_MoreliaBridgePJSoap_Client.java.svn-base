 ...
 * 2013-11-19T11:56:32.670-06:00
 * Generated source version: 2.7.0
 * 
 */
public final class MoreliaBridgePJSoap_MoreliaBridgePJSoap_Client {

    private static final QName SERVICE_NAME = new QName("http://moreliapj.enable.ws.nsjp.segob.gob.mx/", "MoreliaBridgePJ");

    private MoreliaBridgePJSoap_MoreliaBridgePJSoap_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        MoreliaBridgePJSoap port = ss.getMoreliaBridgePJSoap();  
        
        {
        System.out.println("Invoking solicitarAudiencia...");
        java.lang.String _solicitarAudiencia_xmlSolicitud = "_solicitarAudiencia_xmlSolicitud-1070296922";
