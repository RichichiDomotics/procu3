...
public class IngresarIndividuoForm extends GenericForm{
	...
	/**
	 * Método de acceso al campo esReincidente.
	 * @return El valor del campo esReincidente
	 */
	public Boolean getEsReincidente() {
		return esReincidente;
	}
	/**
	 * Asigna el valor al campo esReincidente.
	 * @param estaDetenido el valor esReincidente a asignar
	 */
