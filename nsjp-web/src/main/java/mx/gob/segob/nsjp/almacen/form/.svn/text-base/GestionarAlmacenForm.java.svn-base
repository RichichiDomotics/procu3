 ...
 * 
 */
package mx.gob.segob.nsjp.almacen.form;
 ...
 *
 */
public class GestionarAlmacenForm extends GenericForm {
	...
	private String radioEsVirtual;
	private String radioResguardaEV;
	...
	/**
	 * @return the radioEsVirtual
	 */
	public String getRadioEsVirtual() {
		return radioEsVirtual;
	}
	/**
	 * @param radioEsVirtual the radioEsVirtual to set
	 */
	public void setRadioEsVirtual(String radioEsVirtual) {
		this.radioEsVirtual = radioEsVirtual;
	}
	/**
	 * @return the radioResguardaEV
	 */
	public String getRadioResguardaEV() {
		return radioResguardaEV;
	}
	/**
	 * @param radioResguardaEV the radioResguardaEV to set
	 */
	public void setRadioResguardaEV(String radioResguardaEV) {
		this.radioResguardaEV = radioResguardaEV;
	}
	/**
	 * @return the pais
	 */
