...
//				}
	...
	public ActionForward enviarAvisosDetencion(ActionMapping mapping,
		...
		try {
			...
			String numeroExpediente=request.getParameter("numeroExpediente");
			System.out.print("numero expediente: " + numeroExpediente);
			ExpedienteDTO expedienteDTO=super.getExpedienteTrabajo(request, numeroExpediente);
			System.out.print("ExpedienteDTO: " + expedienteDTO);

			//Se obtiene el id del individuo a consultar
			Long idIndividuo=NumberUtils.toLong(request.getParameter("idIndividuo"), 0);
			System.out.print("Id del individuo " + idIndividuo);
...
//			}
			...
			System.out.print("idDistrito: " + idDistrito);
			System.out.print("claveAgencia: " + claveAgencia);


			//se declara la forma
			IngresarIndividuoForm forma = (IngresarIndividuoForm) form;
			System.out.print("forma.getFechaFinLapso() :: " + forma.getFechaInicioLapso()+" " +forma.getHoraInicioLapso());
			...
			System.out.print("************************* ENVIANDO AVISO DETENCION *******************************");
	...
	public ActionForward consultarDenunciaDetencion(ActionMapping mapping,
		...
		try {
			...
			System.out.print("bandera denuncia generada"+flagDenunciaGenerada);
			if (log.isDebugEnabled()) {
				log.debug(xml);
	...
	public ActionForward validarActividadDocumentos(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException {
