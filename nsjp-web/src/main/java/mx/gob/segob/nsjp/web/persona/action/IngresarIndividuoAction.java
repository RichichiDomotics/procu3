			...
			if (forma.getCalidadDelIndividuo().equals(
				...
				if (forma.getEsPersonaMoral()) {
					...
					if(forma.getEstaDetenido()){
						...
						forma.setFechaFinLapso(request.getParameter("fechaFinLapso"));
						System.out.print("Seteando la fecha de recepcion"+request.getParameter("fechaFinLapso"));
						forma.setHoraFinLapso(request.getParameter("horaFinLapso"));
						System.out.print("Seteando la hora de recepcion"+request.getParameter("horaFinLapso"));
						...
						detencionDTO.setFechaFinDetencion(request.getParameter("fechaFinLapso"));
						detencionDTO.setHoraFinDetencion(IngresarHechosAction.FormateaHora(request.getParameter("horaFinLapso")));
