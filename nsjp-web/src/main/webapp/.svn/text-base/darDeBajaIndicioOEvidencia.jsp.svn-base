        ...
        <body>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td align="right">
                        <input type="text" id="apellidoPaterno" class="parametro" size="60" onkeypress="return soloLetrasNPunto(event,this.id);">
                    </td>
                </tr>
                <tr>
                    <td align="left">
                    ...
                    <td align="right">
                        <input type="text" id="apellidoMaterno" class="parametro" size="60" onkeypress="return soloLetrasNPunto(event,this.id);">
                    </td>
                </tr>
                <tr>
                    <td align="left">
                    ...
                    <td align="right">
                        <input type="text" id="nombre" class="parametro" size="60" onkeypress="return soloLetrasNPunto(event,this.id);">
                    </td>
                </tr>
                <tr>
                    <td align="left">
