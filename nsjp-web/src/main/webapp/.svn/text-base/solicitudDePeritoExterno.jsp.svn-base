				...
				<div id="tabsconsultaprincipal-1">
					<table width="100%" border="0" height="90%">
						<tr>
							...
							<td>
								<input type="text" class="" size="50" maxlength="50" id="solDePericialNombre" onkeypress="return soloLetrasNPunto(event,this.id);"/>
							</td>
						</tr>
						<tr>
							<td>
									...
									<div id="divCriterioTipoSolicitudPeritoNombre">
										<table>
											<tr>
												...
												<td>
													<input type="text" class="" size="50" maxlength="50" id="nombreCriterioPerito" onkeypress="return soloLetrasNPunto(event,this.id);"/>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td>
													<input type="text" size="50" maxlength="50"	id="apPaternoCriterioPerito"  onkeypress="return soloLetrasNPunto(event,this.id);"/>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td>
													<input type="text" size="50" maxlength="50" id="apMaternoCriterioPerito" onkeypress="return soloLetrasNPunto(event,this.id);"/>
												</td>
											</tr>
											<tr>
												<td colspan="2">
