			...
			if(gridDelDia == true){
				...
				jQuery("#gridAudienciaDelDiaPJENS").jqGrid({ 
					...
					colModel:[ 	{name:'numeroCaso',index:'numeroCaso',width:200,align:'center'},
								...
								{name:'tipoAudiencia',index:'tipoAudiencia', width:120,align:'center'},
								{name:'fechaAudiencia',index:'fechaAudiencia', width:120,align:'center'}, 
								{name:'horaAudiencia',index:'horaAudiencia', width:120,align:'center'},
