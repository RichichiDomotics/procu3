 ...
 <script type="text/javascript">
	...
	*/
	function seteaInformacionOrganizacionSectorPublico(xml)
	{
		...
		$('#cbxIngOrgSecPublicoNivelDependencias').find("option[value='"+$(xml).find('organizacionDTO').find('valorByNivelDependencia').find('idCampo').text()+"']").attr("selected","selected");
		onSelectChangeNivelDependencia();
 		$('#cbxIngOrgSecPublicoTiposDependencias').find("option[value='"+$(xml).find('organizacionDTO').find('valorByTipoDependencia').find('idCampo').text()+"']").attr("selected","selected");
 		onSelectChangeTipoDependencia();
