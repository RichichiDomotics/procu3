...
<script type="text/javascript">
	...
	/* eNABLE IT: variable para cargar los documentos */
	...
	$(document).ready(function() {
		...
		ocultaDivOperativo();			
		consultarDistritos();
		//eNABLE IT: Se agrega funcion para cargar documentos relacionados
...
// 		if(tipo!="" && placas!="")
	...
	*/
	...
	//eNABLE IT: Se agregan funciones para cargar documentos
...
<div id="dialog-Alert" style="display: none">
	...
	<div id="tabsconsultaprincipal">
							...
							<td valign="top">
								<table>
									...
									<!-- <tr>
										...
										<td><input type="text" style="width: 180px;" maxlength="50" id="datosGeneralesCmpSector" /></td>
										<td>&nbsp;</td>
									</tr> -->
									<!-- <tr>
		...
		<div id="tabsconsultaprincipal-7">
			<!-- eNABLE IT: Se agregan grids para ver los documentos -->
		...
		<div id="tabsconsultaprincipal-9" class="tabTabsCadCus">
				 <input type="button" class="btn_Generico" id="btnCadCusNuevaCadCus" onclick="asentarRegCadenaCustodia()" style="width: 250px;" value="Crear nueva cadena de custodia"/><br/><br/>
				 <input type="button" class="btn_Generico" id="btnCadCusConsultaCadCus" onclick="consultarRegCadenaCustodia()" style="width: 250px;" value="Consultar cadena de custodia"/><br/><br/>    
  				 <!-- eNABLE IT: Se ocultan botones ya que no tienen funcionalidad -->
