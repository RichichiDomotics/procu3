...
//***********************************************************FUNCIONALIDAD MANDAMIENTOS JUDICIALES**************************************************************/
	...
	* 
	*/
	function mostrarVentanaMandamientoJudicial(idInvolucrado){
...
//		}			
	...
	*/
	...
	function validaSeleccionDeMandamiento(){
		...
		if (rowid) {
			$("#divAgregarMJ").dialog("close");
			mostrarVentanaMandamientoJudicial(rowid);
		}else{
		...
		<div id="tabsconsultaprincipal-1">
			...
			<table width="1000" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>	
					...
					<td>&nbsp;</td>
					<td align="center">
						<input type="button" colspan="2" class="btn_mediano" width="100" id="btnVideos" value="Videos de JAVS" onclick="invocacionConsultaAudienciaJAVS();"/>
					</td>
				</tr>				
			</table>
			...
			<table width="950" border="0" cellspacing="0" cellpadding="0">
			    ...
			    <tr>
			        <td align="right">&nbsp;</td>
	  		        ...
	  		        <td align="center"><input type="submit" id="GenerarMandamiento" value="Generar Mandamiento Judicial" class="btn_Generico"/></td>
