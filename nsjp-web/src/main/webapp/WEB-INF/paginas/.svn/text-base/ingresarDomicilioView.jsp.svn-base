		...
		$.ajax({
		  ...
		  success: function(xml){
			...
			primeraEntidad = $(xml).find('asentamiento').first();
			 ...
			 //Enable JC. Cargar colonia usando el CP en el visor de Domicilio
			 var coloniaID = primeraEntidad.find('asentamientoId').text();
			 $('#cbxAsentamientoColonia').find("option[value='"+coloniaID+"']").attr("selected","selected");
		  }
		});
	  }
			...
			$.ajax({
				  ...
				  success: function(xml){
					//cleanAllCombosCodigoPostal();
						...
						//Enable JC. Cargar colonia usando el CP en el visor de Domicilio
						 var coloniaID = primeraEntidad.find('asentamientoId').text();
						 $('#cbxAsentamientoColoniaNotif').find("option[value='"+coloniaID+"']").attr("selected","selected");
				  }
			});
