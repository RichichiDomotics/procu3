...
<table width="100%" border="0">
  <tr>
    ...
    <td width="30%">
      <input type="text" name="textfield" id="textfield" onkeypress="return soloLetrasNPunto(event,this.id);"/>
    </td>
  ...
  <tr>
    ...
    <td><input type="text" name="textfield2" id="textfield2" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td>*Escolaridad:</td>
  ...
  <tr>
    ...
    <td><input type="text" name="textfield3" id="textfield3" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td>*Estado Civil:</td>
