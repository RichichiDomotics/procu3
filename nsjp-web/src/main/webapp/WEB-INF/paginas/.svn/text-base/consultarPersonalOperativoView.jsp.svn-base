...
<script type="text/javascript">
  ...
  <tr>
    ...
    <td width="252"><input type="text" size="20px" id="apaterno" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td width="239">Apellido Materno:</td>
    <td width="205"><input type="text" size="20px" id="amaterno" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
  </tr>
  <tr>
    <td>RFC:</td>
