...
<html>
	...
	<script type="text/javascript">
		...
		var institucionUsuario='<%= usuario.getInstitucion().getConfInstitucionId()%>';
		var pj = '<%=Areas.PJ.parseLong()%>';
						...
						if(nombreGeneralOP!=""){							
							...
							$.ajax({								
						    	  ...
						    	  success: function(xml){
						    		  if(elemntoNuevo=="si"){
						    			...
						    			//Agregado para asociar la victima a la audiencia
							    		  if(audienciaId != null && audienciaId != ""){
							    			  alert("La audienciaID es:"+audienciaId);
						    		  ...
						    		  idindi=$(xml).find('IngresarIndividuoForm').find('idIndividuo').text();
									  window.parent.pintarTabVictima();
						    		  alertDinamico2('Víctima Guardada');
						    		  desavilitaDatos();
						    	  }
						    	});
						    	  ...
						    	  success: function(xml){
						    		  ...
						    		  {  
										...
										if($('#anularInvolucrado').is(':checked')=='false' || $('#anularInvolucrado').is(':checked')==false)
										{
						    			  ...
						    			  if (idVictima == "null" && institucionUsuario ==pj){
