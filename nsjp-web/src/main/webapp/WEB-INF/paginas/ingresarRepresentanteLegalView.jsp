...
//					alert("Denunciante tiene::::"+idDenunciante);
					if(idDenunciante != "null" && idDenunciante != null && idDenunciante!=""){
							...
							<table width="100%" align="right">
								<tr>
									...
									<td width="37%" align="right">
										<input type="text" size="40" maxlength="40" id="RLegalCmpCalidad" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<td align="right">
