...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				...
				jQuery("#gridProgramas").jqGrid({
					...
					colNames:['Tipo','Nombre','Fecha Inicio','Fecha Termino', 'Puntos', 'Autorizaci&oacute;n'], 
					colModel:[ 	{name:'Tipo',index:'1' }, 
								{name:'Nombre',index:'2'}, 
								{name:'FechaInicio',index:'3'}, 
								{name:'FechaTermino',index:'4'},
								{name:'Puntos',index:'5'},
								{name:'Autorizacion',index:'6'}
							],
	...
	function enviarParaAutorizacion(asignacionProgramaId){
		var confActividadId=<%=ConfActividadDocumento.GENERAR_PLAN_DE_REINSERCION_SOCIAL.getValorId()%>;
		var actividad=0;
		var formaID=4;
		var titulo="op";
		var usaeditor="";
		...
		if(usaeditor == "true"){			
			var parametros = "?formaId="+formaID+"&numeroUnicoExpediente="+cNumeroExpediente + "&actividadId=" + actividad + "&sentenciaId=" + sentenciaId + "&asignacionProgramaId=" + asignacionProgramaId ;
