...
// 					$("#botonCarpetaInvestigacion").hide();
	...
	function colorTabNotas(){
		$('.tabTabsNotas a.lleno').css('background-color','#DF0101');
		$('.tabTabsNotas a.lleno').css('color','#FFFFFF');
	}
	...
	*/
	...
	/**FIN seleccion de actuacion de policia ministerial**/
		...
		*/
		...
		function cerrarVentanaProbableResponsable2(){
	    		...
	    		success: function(xml){
	    	      $(xml).find('involucradoViewDTO').each(function(){
		    	      if($(this).find('calidad').text() == '<%= Calidades.DENUNCIANTE.getValorId() %>' || $(this).find('calidad').text() == '<%= Calidades.DENUNCIANTE_ORGANIZACION.getValorId() %>'){
						  ...
						  $('.tabTabsDenunciante a.lleno').css('background-color','#DF0101');
						  $('.tabTabsDenunciante a.lleno').css('color','#FFFFFF');
						  $('.tabTabsInv a.lleno').css('background-color','#DF0101');
						  $('.tabTabsInv a.lleno').css('color','#FFFFFF');
		    	      ...
		    	      if($(this).find('calidad').text() == '<%= Calidades.VICTIMA_PERSONA.getValorId() %>' || $(this).find('calidad').text() == '<%= Calidades.DENUNCIANTE.getValorId() %>'){
		    	    	  if($(this).find('esVictima').text()=="true"){
								...
								if($(this).find('nombre').text()=='null'){
								  ...
								  liga += '</a></td></tr>';
				    	    	  $('#tblVictima').append(liga);
								  $('.tabTabsVictima a.lleno1').css('background-color','#DF0101');
								  $('.tabTabsVictima a.lleno1').css('color','#FFFFFF');
		    	      ...
		    	      if($(this).find('calidad').text() == '<%= Calidades.PROBABLE_RESPONSABLE_PERSONA.getValorId() %>' || $(this).find('calidad').text() == '<%= Calidades.PROBABLE_RESPONSABLE_ORGANIZACION.getValorId() %>'){
						  ...
						  liga += '</a></td></tr>';
		    	    	  $('#tblProbableResponsable').append(liga);
						  $('.tabTabsImputado a.lleno2').css('background-color','#DF0101');
						  $('.tabTabsImputado a.lleno2').css('color','#FFFFFF');
		    	      }
		    	      if($(this).find('calidad').text() == '<%= Calidades.TESTIGO.getValorId() %>'){
						  ...
						  $('.tabTabsTestigo a.lleno3').css('background-color','#DF0101');
						  $('.tabTabsTestigo a.lleno3').css('color','#FFFFFF');
		    	      }
		    	      if($(this).find('calidad').text() == '<%= Calidades.TRADUCTOR.getValorId() %>'){
						  ...
						  $('.tabTabsTraductor a.lleno4').css('background-color','#DF0101');
						  $('.tabTabsTraductor a.lleno4').css('color','#FFFFFF');
		    	      }		    
		    	      if($(this).find('calidad').text() == '<%= Calidades.QUIEN_DETUVO.getValorId() %>'){
						  ...
						  $('.tabTabsQuienDetuvo a.lleno5').css('background-color','#DF0101');
						  $('.tabTabsQuienDetuvo a.lleno5').css('color','#FFFFFF');
		    	      }
	    		...
	    		success: function(xml){
	    			if(parseInt($(xml).find('code').text())==0)
		    		{
			    	      $(xml).find('hechoDTO').each(function(){
							  ...
							  //$('#tableHecho').css('background-color','#D5D5D4');
			    	    	//deshabilitamos el boton de guardado
			    	    	  $('#ingresarHechos').css('display','none');
							  $('.tabTabsHechos a.lleno').css('background-color','#DF0101');
							  $('.tabTabsHechos a.lleno').css('color','#FFFFFF');
							  $('.ui-tabs .ui-tabs-nav LI.ui-tabs-selected .tabTabsHechos a.lleno').css('background-color','#69E669');
			    	      });
		    		}  
	    		}	
	    	});
		...
		*/
		...
		function cerrarVentanaTraductor(){
		    var pantalla ="iframewindowTraductor";
		...
		function datosGenerales(){
			 $.ajax({
		    	  ...
		    	  success: function(xml){
						...
						if($(xml).find('totalVehiculos').text() >= "1"){
							$('.tabTabsVehiculo a.lleno6').css('background-color','#DF0101');
						    $('.tabTabsVehiculo a.lleno6').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
							$('.tabTabsGrals a.lleno').css('background-color','#FF8000');
						    $('.tabTabsGrals a.lleno').css('color','#FFFFFF');
						}
						if($(xml).find('ve').text()!="1"){
							$('#imgVehiculo').hide();
						}
						$('#EquiposDeComputo').html($(xml).find('totalEquiposComputo').text()+': '+$(xml).find('equiposComputo').text());
						if($(xml).find('totalEquiposComputo').text() >= "1"){
							$('.tabTabsComputo a.lleno7').css('background-color','#DF0101');
						    $('.tabTabsComputo a.lleno7').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalEquiposTelefonicos').text() >= "1"){
							$('.tabTabsTelefono a.lleno8').css('background-color','#DF0101');
						    $('.tabTabsTelefono a.lleno8').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalArmas').text() >= "1"){
							$('.tabTabsArma a.lleno9').css('background-color','#DF0101');
						    $('.tabTabsArma a.lleno9').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalExplosivos').text() >= "1"){
							$('.tabTabsExplosivo a.lleno10').css('background-color','#DF0101');
						    $('.tabTabsExplosivo a.lleno10').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalSustancias').text() >= "1"){
							$('.tabTabsSustancia a.lleno11').css('background-color','#DF0101');
						    $('.tabTabsSustancia a.lleno11').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalAnimales').text() >= "1"){
							$('.tabTabsAnimal a.lleno12').css('background-color','#DF0101');
						    $('.tabTabsAnimal a.lleno12').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalNumerarios').text() >= "1"){
							$('.tabTabsNumerario a.lleno13').css('background-color','#DF0101');
						    $('.tabTabsNumerario a.lleno13').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalVegetales').text() >= "1"){
							$('.tabTabsVegetal a.lleno14').css('background-color','#DF0101');
						    $('.tabTabsVegetal a.lleno14').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalDocumentosOficiales').text() >= "1"){
							$('.tabTabsDocOficial a.lleno15').css('background-color','#DF0101');
						    $('.tabTabsDocOficial a.lleno15').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalJoyas').text() >= "1"){
							$('.tabTabsJoya a.lleno16').css('background-color','#DF0101');
						    $('.tabTabsJoya a.lleno16').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalObrasDeArte').text() >= "1"){
							$('.tabTabsArte a.lleno17').css('background-color','#DF0101');
						    $('.tabTabsArte a.lleno17').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalOtrosObjestos').text() >= "1"){
							$('.tabTabsOtros a.lleno18').css('background-color','#DF0101');
						    $('.tabTabsOtros a.lleno18').css('color','#FFFFFF');
							$('.tabTabsObjs a.lleno').css('background-color','#DF0101');
						    $('.tabTabsObjs a.lleno').css('color','#FFFFFF');
						}
						...
						if($(xml).find('totalDocumentosDelExpediente').text()>"0"){
...
<div id="dialog-Alert" style="display:none">
	...
	<div id="tabs">
		<ul>
			...
			<li class="tabTabsHechos"><a class="lleno" href="#tabs-3">Hechos</a></li>
			<li class="tabTabsInv"><a class="lleno" href="#tabs-1">Involucrado</a></li>
			<li class="tabTabsDelito"><a class="lleno" href="#tabs-2" onclick="cargaComboProbableResponsableRDPPVDelito()">Delito</a></li>
			<li class="tabTabsObjs"><a class="lleno" href="#tabs-4">Objetos y evidencias</a></li>
			...
			<li class="tabTabsAcciones"><a class="lleno" href="#tabs-7">Actuaciones</a></li>			
			<li class="tabTabsDocs"><a class="lleno"href="#tabs-11" onclick="documentos()">Documentos</a></li>
			<li class="tabTabsNotas"><a class="lleno" href="#tabs-5">Notas</a></li>
			<!--li class="tabTabsPeri"><a class="lleno" href="#tabs-8">Periciales</a></li> <!--onclick : gridPericiales() -->
			<!--li class="tabTabsPolMin"><a class="lleno" href="#tabs-9" onclick="">Policía ministerial</a></li-->
			<li class="tabTabsCadCus"><a class="lleno" href="#tabs-10" onclick="gridCustodia()">Cadena de custodia</a></li>
			<!--li class="tabTabsAudiencias"><a class="lleno" href="#tabs-12">Judiciales</a></li-->
			<li class="tabTabsAlertas"><a class="lleno" href="#tabs-14" onclick="alertas()">Bitácora de alarmas</a></li>
			<!--li class="tabTabsAmparos"><a class="lleno"  href="#tabs-15" onclick="consultarAmparosPorExpediente()">Amparo</a></li-->
			<li class="tabTabsGrals"><a class="lleno" href="#tabs-6" onclick="datosGenerales();existenAmparosEnExpediente();buscarNumerosDeExpediente()">Resumen</a></li>
		</ul>
		...
		<div id="tabs-1" class="tabTabsInv">		
			<div id="tabschild" class="tabs-bottom">
				<ul>
					<li class="tabTabsDenunciante"><a class="lleno" href="#tabschild-1">Denunciante</a></li>
					<li class="tabTabsVictima"><a class="lleno1" href="#tabschild-2">Víctima</a></li>
					<li class="tabTabsImputado"><a class="lleno2" href="#tabschild-3">Imputado</a></li>
					<!--<li><a href="#tabschild-3" id="tapProbableResposable"></a></li> -->
					<li class="tabTabsTestigo"><a class="lleno3" href="#tabschild-4">Testigo</a></li>
					<li class="tabTabsTraductor"><a class="lleno4" href="#tabschild-5">Traductor</a></li>
					<li class="tabTabsQuienDetuvo"><a class="lleno5" href="#tabschild-6">Quién detuvo</a></li>
				</ul>
				<div id="tabschild-1">
...
<!-- 									<b>Nombre del MP dueño del expediente auditado : </b> -->
		...
		<div id="tabs-4" class="tabTabsObjs">
			...
			<div id="tabschild4" class="tabs-bottom">
				...
				<ul>
					<li class="tabTabsVehiculo"><a class="lleno6" onclick="consultaGridVehiculosVisor()" href="#tabschild4-7">Veh&iacute;culo</a></li>
					<li class="tabTabsComputo"><a class="lleno7" onclick="consultaGridEquiposComputoVisor()" href="#tabschild4-1">Equipo de c&oacute;mputo</a></li>
					<li class="tabTabsTelefono"><a class="lleno8" onclick="consultaGridEquipoTelefonicoVisor()" href="#tabschild4-2">Equipo telef&oacute;nico</a></li>
					<li class="tabTabsArma"><a class="lleno9" class="lleno6"onclick="consultaGridArmasVisor()" href="#tabschild4-3">Arma</a></li>
					<li class="tabTabsExplosivo"><a class="lleno10" onclick="consultaGridExplosivoVisor()" href="#tabschild4-4">Explosivo</a></li>
					<li class="tabTabsSustancia"><a class="lleno11" onclick="consultaGridSustanciaVisor()" href="#tabschild4-5">Sustancia</a></li>
					<li class="tabTabsAnimal"><a class="lleno12" onclick="consultaGridAnimalVisor()" href="#tabschild4-6">Animal</a></li>					
					...
					<li class="tabTabsNumerario"><a class="lleno13" onclick="consultaGridNumerarioVisor()" href="#tabschild4-11">Numerario</a></li>
					<li class="tabTabsVegetal"><a class="lleno14" onclick="consultaGridVegetalVisor()" href="#tabschild4-12">Vegetal</a></li>
					<li class="tabTabsDocOficial"><a class="lleno15" onclick="consultaGridDocumentoOficialVisor()" href="#tabschild4-13">Documento oficial</a></li>
					<li class="tabTabsJoya"><a class="lleno16" onclick="consultaGridJoyaVisor()" href="#tabschild4-14">Joya</a></li>
					<li class="tabTabsArte"><a class="lleno17" onclick="consultaGridObraDeArteVisor()" href="#tabschild4-15">Obra de arte</a></li>	
					<li class="tabTabsOtros"><a class="lleno18" onclick="consultaGridOtrosVisor()" href="#tabschild4-16">Otros</a></li>		
				</ul>
