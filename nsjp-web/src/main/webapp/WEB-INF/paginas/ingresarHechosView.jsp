...
// 							}
// 						}else{
// 						$('#txtDireccionGoogle').val('No hay conexión a internet. Favor de contactar al administrador');
...
/*Inicio de funciones de mapa /*ByYolo Enable IT*/
  ...
  function reverseGeocodeResult(results, status) {
    ...
    if(status == 'OK') {
	  ...
	  direccionMapa = 'No hay conexión a internet. Favor de contactar al administrador';
	  $('#txtDireccionGoogle').val(direccionMapa);
	  $('#txtDireccionGoogle').attr("disabled","disabled");
    }
					    ...
					    <table width="1042px"  height="490px" border="0" cellspacing="0" cellpadding="0" class="back_hechos">
					     <tr>
    						<td>
								...
								<p align="center" style="font-size:25px;"><b>Selecccione una opci&oacute;n</b></p>
			                        <tr valign="top">
			                          <td width="20px">&nbsp;</td>
