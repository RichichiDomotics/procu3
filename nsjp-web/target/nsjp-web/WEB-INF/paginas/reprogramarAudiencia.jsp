...
//	 		EnableIT By Asdrubal se agregan variables para recuperar el nombre de la sala seleccionada
			...
			/*Enable IT eliminando validacion horario reprgoramacion audiencia*/
								...
								*/
								...
								// Con agendar audiencia en JAVS							
								    ...
								    if(S_Mensaje!=""){
										...
										//customAlert("Error al reagendar audiencia en servidor JAVS, no hay conexión con el WS");
								    	customAlert("Error al reagendar audiencia");
								    }
								}
