        	...
        	idProbResAviso = idPRval;
	    		...
	    		if(avisoDetencion==false){
		    		...
		    		if(detImp){
						...
						$('#idFechaDateLapso').val(fechaDet.substring(8,10)+"/"+fechaDet.substring(5,7)+"/"+fechaDet.substring(0,4));
			    		$('#idHoraDateLapsoInicio').val(fechaDet.substring(11,16));
			    		//$('#idFechaDateLapso2').val(fechaRecep.substring(0,10));
						$('#idFechaDateLapso2').val(fechaRecep.substring(8,10)+"/"+fechaRecep.substring(5,7)+"/"+fechaRecep.substring(0,4));
