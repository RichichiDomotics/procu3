		...
		$(document).ready(function(){
			...
			jQuery("#gridCatDelitos2").jqGrid({ 
				...
				colModel:[ 	{name:'Clave',index:'clave', width:40}, 
							...
							{name:'GravedadFormateada',index:'GravedadFormateada',width:55,align:'center'},
...
// 				autowidth: true,
			...
			$("#gview_gridDelitosAgraviados2 .ui-jqgrid-bdiv").css('width', '500px');
		});
...
<body>
	<table border="0"  width="900px">
		...
		<tr>
			<td>
				<table id="gridCatDelitos2" width="400px"></table>
				<div id="pager1"></div>
			</td>
			<td>
			...
			<td>
				<table id="gridDelitosAgraviados2" width="500px"></table>
				<div id="pgrid2"></div>
<!-- 				/*se elimina leyenda en delitos al levantar la denuncia/*ByYolo*/ -->
				<span id="leyendaUnDelitoGrave2">Se debe canalizar a la Unidad de Investigadores</span>
