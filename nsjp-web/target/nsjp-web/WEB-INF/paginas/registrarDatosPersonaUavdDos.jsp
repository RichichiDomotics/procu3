...
<form id="profileForm" class="actionForm"  method="get">
 ...
 <div class="error1" style="display:none;">
	...
	<tr>
		...
		<td  class="field">
			<input type="text" class="" style="width: 180px;background-color: #EEEEEE; border: 0;" maxlength="30" id="datosGeneralesCmpNombres" name="datosGeneralesCmpNombres"  value="" onkeydown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onkeyup="espejoDatos();"/>
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" style="width: 180px;background-color: #EEEEEE; border: 0;" maxlength="30" class="" id="datosGeneralesCmpApaterno" name="datosGeneralesCmpApaterno" onkeydown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onkeyup="espejoDatos();"/>
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" style="width: 180px;background-color: #EEEEEE; border: 0;;" maxlength="30" class="" id="datosGeneralesCmpMaterno"  name="datosGeneralesCmpMaterno" onkeydown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onkeyup="espejoDatos();"/>
		</td>
		<td >&nbsp;</td>
		<td >&nbsp;</td>
		<td >&nbsp;</td>
