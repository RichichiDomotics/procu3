...
<form name="formaAgregar" id="formaAgregar">
	...
	<td width="30%">
		<strong>Tiempo de asignaci&oacute;n:</strong><input type="text" id="fechaVencimiento"/>
	</td>
	<td width="40%">
