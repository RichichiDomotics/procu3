				...
				$( "#dialog-Alert" ).dialog({
					...
					buttons: {
						...
						"Aceptar": function() {
							$( this ).dialog( "close" );
							$("#divAlertTexto").html("");
							window.parent.cerrarVentanaProbableResponsable2();
						}
					}
				});
			 }
				...
				if(tipoResponsable == 1){//Tipo de responsable fisico
					...
					$.ajax({								
				    	  ...
				    	  success: function(xml){
							...
							alertDinamico2(''+probableResponsableProp+' guardado');
				    	  ...
				    	  success: function(xml){
				    		  if(parseInt($(xml).find('code').text())==0)
				    		  {
								...
								if($('#anularInvolucrado').is(':checked')=='false' || $('#anularInvolucrado').is(':checked')==false)
								{
									  ...
									  window.parent.pintarTabImputado();
						    		  alertDinamico2("La Organización se guardó exitosamente");
				...
				if(tipoResponsable == 1){//Tipo de responsable fisico
					...
					$.ajax({								
				    	  ...
				    	  success: function(xml){
							...
							$('#chkDefensor').attr("disabled","");
							var probableResponsableProp = '<bean:message key="msjProbableResponsable"/>';
							alertDinamico(''+probableResponsableProp+' guardado');
							enviaImagenDeElemento(idElemento,idindi);
				    	  }
				    	});
				}else{//Tipo de responsable moral
