...
<table border="0" width="70%" align="center">
	...
	<tr>
	  ...
	  <td class="field"><input type="text" tabindex="1" class="" size="45" maxlength="45" id="nombreDEATT" name="nombreDEATT"  value="" onKeyDown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onKeyUp="espejoDatos();"/></td>
	...
	<td align="right">Apellido Paterno:</td>
		<td>
			<input type="text" tabindex="2" size="45" maxlength="45" class="" id="aPaternoDEATT" name="aPaternoDEATT" onKeyDown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onKeyUp="espejoDatos();"/>
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" tabindex="3"  size="45" maxlength="45" class="" id="aMaternoDEATT"  name="aMaternoDEATT" onKeyDown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onKeyUp="espejoDatos();"/>
		</td>
