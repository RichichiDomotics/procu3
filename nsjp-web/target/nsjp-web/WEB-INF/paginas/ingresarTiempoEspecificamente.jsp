 ...
 <script type="text/javascript">
     ...
     */
     ...
     function seteaDatosTiempoEspecifico(xml)
     {
    	 ...
    	 /* /Enable IT GB////////////////////////////////////////////////////////// */
    	 var fechaInicio=$(xml).find('strFechaInicio').first().text();
    	 var horaInicio=$(xml).find('strHoraInicio').first().text();
    	 $("#idFechaDate").val(fechaInicio);
    	 $("#idHoraDate").val(horaInicio); 
    	 //////////////////////////////////////////////////////////
