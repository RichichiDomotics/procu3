		...
		*/
		function cargaTodasLasSolicitudes(){
			...
			if(primeraConsulta == true){
				...
				jQuery("#gridSolsXAtndr").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultaSolsXAtnderUAVD.do?tipoSoliciutd='+idsTiposSolicitudes+'&idArea=0&estatus=<%=EstatusSolicitud.ABIERTA.getValorId()%>,<%=EstatusSolicitud.EN_PROCESO.getValorId()%>',datatype: "xml", page:1 });
	...
	function realizarValoracionHechos()
	{
	 ...
	 function registraDatosPersona(idrow) {
		...
		*/
		...
		{
			jQuery("#gridSolsXAtndr").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultaSolsXAtnderUAVD.do?tipoSoliciutd='+tipoSolicitud+'&idArea='+idArea+'&estatus=<%=EstatusSolicitud.ABIERTA.getValorId()%>,<%=EstatusSolicitud.EN_PROCESO.getValorId()%>',datatype: "xml", page:1 });
			$("#gridSolsXAtndr").trigger("reloadGrid");
