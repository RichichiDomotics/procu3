	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			jQuery("#gridDetalleFrmPrincipal").jqGrid({ 
				url: contextoPagina + '/BusquedaCanalizadosRestaurativa.do?area=PM&actividad=ATENDER_CANALIZACION', 
				datatype: "xml", 
		...
		function consultarTiposSolicitudPorAreaDelFuncionario(idDivArbol,idArea)
		{
			...
			$.ajax({
				...
				success: function(xml){
					...
					var trTabla = '<tr>';
					trTabla=trTabla + '<td><img src="<%=request.getContextPath()%>/resources/css/treeview/images/folder-closed.gif" width="20" height="16" /><a id="Mediar8" onclick="recargaGridExpedientesEstatus(1);">Archivo temporal</a></td>';
					trTabla = trTabla + '</tr>';
					$('#'+idDivArbol).append(trTabla);
					trTabla = '';
					trTabla = '<tr>';
	...
	<div class="ui-layout-west">	
		<div class="header">&nbsp;</div>
			<div class="content">
				...
				<!-- Enable IT JC Requerimiento 23 para Oaxaca
