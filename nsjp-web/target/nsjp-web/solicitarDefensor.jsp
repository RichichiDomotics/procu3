				...
				<div id="tabsconsultaprincipal-1">
					<table width="100%" border="0" height="90%">
						<tr>
							...
							<td>
								<input type="text" class="" size="50" maxlength="50" id="solDeSSPNombre" disabled="disabled" onkeypress="return soloLetrasNPunto(event,this.id);"/>
							</td>
						</tr>
						<tr>
							<td align="right">
				...
				<div id="tabsconsultaprincipal-2">
					<table width="100%" border="0" height="90%">
						...
						<tr>
							...
							<td>
								<input type="text" size="50" maxlength="50"	id="solDeSSPNombreDetenido"  onkeypress="return soloLetrasNPunto(event,this.id);"/>
							</td>
						</tr>
						<tr>
							<td align="right">
