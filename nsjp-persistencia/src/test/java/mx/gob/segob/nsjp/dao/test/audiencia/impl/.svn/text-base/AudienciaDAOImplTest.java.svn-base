...
public class AudienciaDAOImplTest extends BaseTestPersistencia<AudienciaDAO> {
	...
	public void testconsultarAudienciasDeSolicitudTranscripcion(){
		List<Audiencia> solicitudes =  daoServcice.consultarAudienciasDeSolicitudAudiencia(14L, 2L, 
...
//        au.setFechaAudiencia(cal.getTime());
    ...
    public void testBuscarAudiencias(){
    	...
    	String rol=Roles.ENCARGADOSALA.toString();
    	List<Audiencia> audiencias = daoServcice
		.buscarAudiencias(null, null, fechaActual,fechaActual, true, null, false,null,4L,null,rol,3554L);
