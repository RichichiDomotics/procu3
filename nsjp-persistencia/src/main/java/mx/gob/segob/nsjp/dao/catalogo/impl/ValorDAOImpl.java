...
public class ValorDAOImpl extends GenericDaoHibernateImpl<Valor, Long>
	...
	private final static Long CARACTER = 74L;

	@Override
	public Valor consultarComplejidadTipoAudiencia(Valor tipo, boolean flagComplejidad) {
		...
		if(flagComplejidad)
			queryString.append(" AND v.campoCatalogo=" + COMPLEJIDAD);
		else
			queryString.append(" AND v.campoCatalogo=" + CARACTER);
