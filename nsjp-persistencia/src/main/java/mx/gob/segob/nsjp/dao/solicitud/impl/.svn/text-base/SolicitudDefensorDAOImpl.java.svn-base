...
public class SolicitudDefensorDAOImpl extends
	...
	@Override
	public List<SolicitudDefensor> obtenerSolicitudDefensorPorAudienciaID(
			Long audienciaID) {
		StringBuffer hqlQuery = new StringBuffer();
		...
		if(audienciaID != null){
			hqlQuery.append(" WHERE s.audiencia.audienciaId =").append(audienciaID);	
		}
