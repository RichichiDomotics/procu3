...
//        }
    ...
    /**********Metodo para paginacion de SQL Queries ************/
    protected List ejecutarQueryPaginadoSQL(final StringBuffer queryString,final PaginacionDTO pag,Class clase) {
        
    	final SQLQuery query = super.getSession().createSQLQuery(queryString.toString()).addEntity(clase);
