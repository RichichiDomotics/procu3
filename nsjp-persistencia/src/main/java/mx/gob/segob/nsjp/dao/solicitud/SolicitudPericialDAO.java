...
public interface SolicitudPericialDAO extends
    ...
    throws NSJPNegocioException;
 	 ...
 	 * @param  estatus
 	 * @param  destinatario
 	 * @return  List<SolicitudPericial>
 	 * @throws NSJPNegocioException
 	 */
      List<SolicitudPericial> consultarSolicitudesPericialesPorEstatus(EstatusSolicitud estatus, 
     		Funcionario destinatario)
     throws NSJPNegocioException;
      
   	/**
   	 * Consulta todas las solicitudes sin parametro
   	 * @author encesarvarga (Enable IT)
   	 * @return List<SolicitudPericial>
   	 * @throws NSJPNegocioException
   	 */
        List<SolicitudPericial> consultarSolicitudesPericialesTodas()
       throws NSJPNegocioException;
   	 ...
   	 * @throws NSJPNegocioException
   	 */
       List<SolicitudPericial> consultarSolicitudesPericialesPorAgencia(Long idAgencia, 
       ...
       throws NSJPNegocioException;        
      	 ...
      	 * Consulta todas las solicitudes sin parametro
      	 * @author encesarvarga (Enable IT)
      	 * @param delFuncionario
      	 * @param destinatario
      	 * @return List<SolicitudPericial>
      	 * @throws NSJPNegocioException
      	 */
          List<SolicitudPericial> consultarSolicitudesPericialesPorUsuario(FuncionarioDTO delFuncionario, 
       		   FuncionarioDTO destinatario)
          throws NSJPNegocioException;     
        ...
        * @throws NSJPNegocioException
        */
         List<SolicitudPericial> consultarSolicitudesPericialesPorDia()
         throws NSJPNegocioException;   
          ...
          * @throws NSJPNegocioException 
          */
         public List<SolicitudPericial> consultarSolicitudesPericialesPorTipoEstatus(TiposSolicitudes tipo,
