...
public interface FuncionarioDAO extends GenericDao<Funcionario, Long> {
	...
	/**
	 * Enable JC. Obtiene todos los subordinados de UAVD.
	 * Desarrollado para funicionalidad de compartir solicitudes, obtiene a todos los funcionarios
	 * siendo coordinadores y de las áreas de UAVD.
	 * @return
	 */
	 ...
	 * @return
	 */
	List<Funcionario> consultarFuncionariosSubordinados(Funcionario funcionario, Long areaId, Long jerarquia);
    ...
    */
	...
	/*/*ByYolo*/
	/**
	* Metodo que permite obtener el funcionario por clavefuncionario
	* @author encesarvarga (Enable IT)
    * @param claveFuncionario
    * @return Funcionario
    */
	public Funcionario consultarFuncionarioPorClaveFuncionario(Long claveFuncionario);
}
