...
public class ExpedienteDAOImpl extends
	...
	@Override
	public String obtenerUltimoNumero(Long nomExpediente) {
...
//			logger.debug("resp.size() :: " + resp.size());
	...
	public String obtenerUltimoNumeroDeExpediente(Long area) {
		...
		queryStr.append("select obj.numeroExpediente from NumeroExpediente obj where obj.numeroExpedienteId=(select MAX(obj1.numeroExpedienteId)from NumeroExpediente obj1)");
		/*if(area != null){
			queryStr.append(" AND obj.jerarquiaOrganizacional.jerarquiaOrganizacionalId = ");
			queryStr.append(area);
		}*/
		System.out.print("queryStr :: " + queryStr+" query completo");
