...
public class DefensaInvolucradoDAOImpl extends
	...
	public DefensaInvolucrado consultarDefensaInvolucrado(Long involucradoId) throws NSJPNegocioException{
		final StringBuffer hqlQuery = new StringBuffer();
		hqlQuery.append(" FROM DefensaInvolucrado di ")
		.append(" WHERE di.involucradoPg.elementoId ="+involucradoId);
		Query query = super.getSession().createQuery(hqlQuery.toString());
		return (DefensaInvolucrado) query.uniqueResult();
		
	}

	@Override
	public DefensaInvolucrado consultarDefensaInvolucradoDF(Long involucradoId)
			throws NSJPNegocioException {
		final StringBuffer hqlQuery = new StringBuffer();
		hqlQuery.append(" FROM DefensaInvolucrado di ")
		.append(" WHERE di.involucrado.elementoId ="+involucradoId);
		Query query = super.getSession().createQuery(hqlQuery.toString());
		return (DefensaInvolucrado) query.uniqueResult();
	}

	@Override
	public void eliminarPorNumeroExpedienteIdYInvolucradoId(
			Long numeroExpedienteId, Long involucradoId)
			throws NSJPNegocioException {
		final StringBuffer hqlQuery = new StringBuffer();
		hqlQuery.append(" DELETE DefensaInvolucrado di ")
		.append(" WHERE di.id.numeroExpedienteId ="+numeroExpedienteId)
		.append("AND di.id.involucradoId ="+involucradoId);
		Query query = super.getSession().createQuery(hqlQuery.toString());		
	}

	@Override
	public List<DefensaInvolucrado> consultarDefensaInvolucradoXNumeroExpedienteID(
			Long numeroExpedienteId) throws NSJPNegocioException {
		final StringBuffer hqlQuery = new StringBuffer();
		hqlQuery.append(" FROM DefensaInvolucrado di ")
		.append(" WHERE di.numeroExpediente.numeroExpedienteId ="+numeroExpedienteId);
