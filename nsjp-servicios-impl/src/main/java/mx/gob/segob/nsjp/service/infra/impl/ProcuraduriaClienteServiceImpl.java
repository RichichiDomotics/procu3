 ...
 * Marca de cambio        : N/A
 * Descripcion General    : Implementaci�n del cliente del ws
...
//         	ep = new URL("http://localhost:8084/nsjp-web"	
             ...
             logger.debug("yolotz�n"+iPHomologadoDTO.getExpediente().getPertenceConfInst().getConfInstitucionId());
             ...
             /*Agregando insitucion de la que se envia /*ByYolo*/
             informePolicialHomologadoWSDTO.getExpediente().setPertenceConfInst(confInsDao.consultarIntitucionActual().getConfInstitucionId());
    ...
    public AvisoHechoDelictivoDTO enviarAvisoHechoDelictivo(
        ...
        try {
            ...
            logger.debug("Enviando AHD a trav�s de " + ep);
