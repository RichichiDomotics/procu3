...
//							se reestrututa el formato del documento
...
//							cuerpoIPH+="<p>Latitud GMS:&nbsp;Grados: "+grados[0]+"&nbsp;Minutos: "+minutos[0]+"&nbsp;Segundos: "+segundos[0]+"</p>";
							cuerpoIPH+="<p>Latitud GMS:&nbsp;: "+coord.getLatitud()+"</p>";
//							se reestrututa el formato del documento							
...
//							cuerpoIPH+="<p>Longitud GMS:&nbsp;Grados: "+grados[0]+"&nbsp;Minutos: "+minutos[0]+"&nbsp;Segundos: "+segundos[0]+"</p>";
							cuerpoIPH+="<p>Longitud GMS:&nbsp;: "+coord.getLongitud()+"</p>";
						}
...
//					strDomicilio=domicilioInvol.getCalle()+" "+domicilioInvol.getNumeroExterior()+" "+domicilioInvol.getCiudad();
				...
				/*Se valida que tenga un siguiente registro se mete dentro del if todo el codigo que afecta este cambio/*Enable IT ByYolo*/
...
//						"<p>Origen:&nbsp;______&nbsp;</p>"+
			...
			if(informe.getFuncionarioElabora()!= null) 
				cuerpoIPH+="<p align=\"center\">"
					+(informe.getFuncionarioElabora()!=null && informe.getFuncionarioElabora().getNombreCompleto()!=null? informe.getFuncionarioElabora().getNombreCompleto():"")
					+"</p>";
...
//    documento.setTextoParcial(null);
	...
	return guardarDocumentoService.guardarDocumento(documento,
			new ExpedienteDTO(informe.getExpediente().getExpedienteId()), null);
}
}
