...
public class RegistrarAvisoDetencionDeAreaExternaImpl implements
	...
	public AvisoDetencionWSDTO registrarAvisoDetencion(AvisoDetencionWSDTO aviso,Long idAgencia, String datosAgencia,Long idFuncionarioSolicitante) throws NSJPNegocioException{
		...
		if(aviso != null){
			...
			logger.info("folio Elemento del Individuo ::: " + aviso.getDetencion().getFolioElemento());
...
//			TODO VAP si el expediente ya tiene un aviso clonarlo
            ...
            logger.debug("avisoInterno.getCatDiscriminanteOrigen() :: " + avisoInterno.getCatDiscriminanteOrigen());
            logger.debug("avisoInterno.getClaveDiscriminanteOrigen() :: " + avisoInterno.getClaveDiscriminanteOrigen());
    		logger.debug("avisoInterno.getDiscriminanteDestino() :: " + avisoInterno.getDiscriminanteDestino());
