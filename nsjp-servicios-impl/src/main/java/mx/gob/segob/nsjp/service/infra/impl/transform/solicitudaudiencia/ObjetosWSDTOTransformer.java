...
import mx.gob.segob.nsjp.ws.cliente.solicitudaudiencia.ActividadWSDTO;
...
//        	destino.setEsPertenencia(src.getEsPertenencia());
    ...
    public static DocumentoWSDTO transforma(DocumentoDTO documentoDto){
        ...
        if(documentoWSDTO.getActividad()!=null){
        	ActividadWSDTO actWSDTO = new ActividadWSDTO();
        	actWSDTO.setTipoActividadId(documentoDto.getActividadDTO().getTipoActividad().getValorId());
        	actWSDTO.setFechaCreacion(WsTransformer.transformFecha(new Date()));
        	documentoWSDTO.setActividad(actWSDTO);
