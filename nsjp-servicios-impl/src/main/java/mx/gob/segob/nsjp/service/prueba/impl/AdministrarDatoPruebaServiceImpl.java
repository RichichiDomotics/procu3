...
//						.getMotivoCancelacion().getIdCampo()));
	...
	@Override
	public List<DatoPruebaDTO> consultarPruebasPorNumeroExpediente(String expedienteId)
			throws NSJPNegocioException {

		logger.info(" Servicio: consultarPruebasPorNumeroExpediente " + expedienteId);
		...
		List<DatoPrueba> pruebas= datoPruebaDAO.buscarPruebasPorExpediente(Long.parseLong(expedienteId));
