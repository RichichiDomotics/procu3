...
public class VisitanteServiceImpl implements VisitanteService {
	 ...
	 * registro existente y en caso de alg�n error env�a false
	 * 
	 * @param visitante
	 * @return
	...
	/**
	 * Consulta un visitante con base en su direcci�n IP y regresa Null en caso
	...
	public VisitanteDTO consultarVisitantePorIP(VisitanteDTO visitanteDTO)
	 ...
	 /**
     * M�todo encargado de reiniciar la cuenta de intentos de una direcci�n IP registrada a cero
     * @throws NSJPNegocioException
     */
	@Override
