...
public class ConsultarAudienciasByFechasYEstatusServiceImpl implements
	...
	public List<AudienciaDefensoriaWSDTO> consultarAudienciasByFechasYEstatus(
		...
		List<Audiencia> audiencias = audienciaDAO
				.buscarAudiencias(null, null, audienciaWSDTO.getFiltroFechaInicio(), audienciaWSDTO.getFiltroFechaFinal(), true, null, false,null,audienciaWSDTO.getIdDistritoFiltroAudiencias(),null,null,null);
	...
	public List<AudienciaDefensoriaWSDTO> consultarAudienciasPorFechasYSolicitudTranscripcion(
		...
		List<Audiencia> audiencias = audienciaDAO.consultarAudienciasDeSolicitudAudiencia(
				audienciaWSDTO.getClaveFuncionarioExt(), 
				audienciaWSDTO.getConfInstId(), null, audienciaWSDTO.getFiltroFechaInicio(), audienciaWSDTO.getFiltroFechaFinal(), 
				true, null, false,null,audienciaWSDTO.getIdDistritoFiltroAudiencias());
