...
public class DelitoDelegatImpl implements DelitoDelegate {
	...
	public Long asociarDelitoResponsableVictima(Long asociacionID,DelitoDTO delito,
			...
			Long idLugar, Long idModalidad, Long idModus, Long idCausa, Long idSituacion)
			throws NSJPNegocioException {	
		return asociarDelitoResponsableVictimaService.asociarDelitoResponsableVictima(asociacionID, delito,
				 ...
				 idLugar, idModalidad, idModus, idCausa, idSituacion);
	}
	...
	public void guardarDelito(List<DelitoDTO> delitosDto,
		...
		guardarDelitoService.guardarDelito(delitosDto, expedienteDto, idDelPrincipal);
	}
	...
	public SituacionImputadoDTO consultarSituacionImputadoPorId(Long idSituacion) throws NSJPNegocioException{
		return consultarDelitoPersonaService.consultarSituacionImputadoPorId(idSituacion);
	}
