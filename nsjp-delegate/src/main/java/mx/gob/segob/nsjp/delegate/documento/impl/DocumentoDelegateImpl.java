...
public class DocumentoDelegateImpl implements DocumentoDelegate {
	...
	public Long guardarDocumento(DocumentoDTO documento,
		...
		return guardarDocumentoService.guardarDocumento(documento,
				expedienteActual,nuevaActividad);
	}
	...
	public List<DocumentoDTO> consultarDocumentosIdSeleccionados(String idSeleccionados ) throws NSJPNegocioException {
		return consultarDocumentoService
				.consultarDocumentosIdSeleccionados(idSeleccionados);
	}
	...
	public Long enviarDocumentoAInstitucion(List<DocumentoDTO> lstDocumentoDTO,
			...
			throws NSJPNegocioException {
		return aInstitucionService.enviarDocumentoAInstitucion(lstDocumentoDTO, numeroExpediente, target);
	}
