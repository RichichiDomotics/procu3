...
public interface SolicitudPericialDelegate {
    ...
    /*inicio interfaces/*ByYolo*/
    /**
	 * Consulta todas las solicitudes por estatus
	 * (Nota: el director de Peritos Ve todas la Solicitudes)
	 ...
	 * @throws NSJPNegocioException
	 */
    public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorEstatus(EstatusSolicitud estatusSolicitud, Long claveFuncionario)
    throws NSJPNegocioException;
    
	/**
	 * Consulta todas las solicitudes del dia en cualquier estatus
	 * @author encesarvarga (Enable IT)
	 * @return Listado de solicitudes encontradas
	 * @throws NSJPNegocioException
	 */
	...
	/**
	 * Consulta todas las solicitudes de el funcionario 
	 * (Nota: el director de Peritos Ve todas la Solicitudes)
	 * @author encesarvarga (Enable IT)
	 * @param destinatario Destinatario de las solicitudes a consultar
	 * @param estatus Estado de la solicitud
	 ...
	 * @throws NSJPNegocioException
	 */
    public List<SolicitudPericialDTO> consultarSolicitudesPericialesTodas(FuncionarioDTO destinatario)
    throws NSJPNegocioException;
    
	/**
	 * Consulta todas las solicitudes de el funcionario por Agencia
	 * (Nota: el director de Peritos Ve todas la Solicitudes)
	 * @author encesarvarga (Enable IT)
	 * @param destinatario Destinatario de las solicitudes a consultar
	 * @param estatus Estado de la solicitud
	 ...
	 * @throws NSJPNegocioException
	 */
    public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorAgencia(Long idAgencia, FuncionarioDTO destinatario)
    throws NSJPNegocioException;
    
    /**
	 * Consulta todas las solicitudes de el funcionario por Usuario
	 * (Nota: el director de Peritos Ve todas la Solicitudes)
	 * @author encesarvarga (Enable IT)
	 * @param destinatario Destinatario de las solicitudes a consultar
	 * @param estatus Estado de la solicitud
	 ...
	 * @throws NSJPNegocioException
	 */
    public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorUsuario(FuncionarioDTO delFuncionario , FuncionarioDTO destinatario)
    throws NSJPNegocioException;
    ...
    /**
     * Consulta una solicitud de servicio pericial en base al estatus de la solicitud
     * y el tipo de solicitud de pericial 
     * @author encesarvarga (Enable IT)
     * @param estado Estado a consultar
     * @param tipo tipo de solicitud a consultar
     * @param area - area del destinatario
     ...
     * @throws NSJPNegocioException 
     */
    public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorTipoEstatus(TiposSolicitudes tipo,
    		EstatusSolicitud estado)
    throws NSJPNegocioException;
    
    /*fin interfaces/*ByYolo*/
