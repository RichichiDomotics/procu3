...
public interface FuncionarioDelegate {
	 ...
	 * @return
	 */
	FuncionarioDTO obtenerFuncionarioPorUsuarioId(Long usuarioID);

	/**
	 * Enable JC. Obtiene a todos los subordinados de UAVD.
	 * Desarrollado para compartir solicitudes todos a todos.
	 * Carga a todos los funcionarios de UAVD, incluyendo coordinadores.
	 * @return
 ...
 * Consulta el Funcionario por filtro enviado en un FuncionarioDTO
    ...
    public List<FuncionarioDTO> consultarFuncionarioXFiltroYRol(FuncionarioDTO funcionarioDTO, RolDTO rolDTO)
    throws NSJPNegocioException;
