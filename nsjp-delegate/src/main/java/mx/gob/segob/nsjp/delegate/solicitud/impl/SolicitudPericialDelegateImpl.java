...
public class SolicitudPericialDelegateImpl implements SolicitudPericialDelegate {
	...
	private static final Logger log  = Logger.getLogger(SolicitudPericialDelegateImpl.class);
	...
	public List<FuncionarioDTO> consultarFuncionarioPorFiltro(FuncionarioDTO filtro,Long rolId)
			throws NSJPNegocioException {	
		return consultarPeritosPorFiltroService.consultarFuncionarioPorFiltro(filtro,rolId);
	}
	...
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorEstatus(
			...
			throws NSJPNegocioException {
		return solicitarPericialService.consultarSolicitudesPericialesPorEstatus(estatusSolicitud, claveFuncionario);
	}	
	
	@Override
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorDia()
			throws NSJPNegocioException {
		return solicitarPericialService.consultarSolicitudesPericialesPorDia();
	}
	...
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesTodas(
		...
		return solicitarPericialService.consultarSolicitudesPericialesTodas(destinatario);
	}
	...
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorAgencia(
			...
			throws NSJPNegocioException {
		return solicitarPericialService.consultarSolicitudesPericialesPorAgencia(idAgencia, destinatario);
	}
	...
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorUsuario(
			...
			throws NSJPNegocioException {
		return solicitarPericialService.consultarSolicitudesPericialesPorUsuario(delFuncionario, destinatario);
	}
	...
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesTodas()
		...
		return solicitarPericialService.consultarSolicitudesPericialesTodas();
	}
	...
	public List<SolicitudPericialDTO> consultarSolicitudesPericialesPorTipoEstatus(
		...
		return solicitarPericialService.consultarSolicitudesPericialesPorTipoEstatus(tipo, estado);
	}

	/*Fin de Delegates /*ByYolo*/
