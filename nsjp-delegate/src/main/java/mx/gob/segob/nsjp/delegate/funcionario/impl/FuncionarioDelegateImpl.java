...
public class FuncionarioDelegateImpl implements FuncionarioDelegate {
    ...
    /*Enable JC*/
    @Autowired
    private ConsultarFuncionarioService consultarFuncService;

    /*Enable JC.*/
    public FuncionarioDTO obtenerFuncionarioPorUsuarioId(Long usuarioID){
    	return consultarFuncService.consultarFuncionarioXUsuarioID(usuarioID);
    }
    /*
	...
	public List<FuncionarioDTO> consultarFuncionarioXNumeroEmpleado(
		...
		return consultarFuncionarioPorFiltro.consultarFuncionarioPorFiltro(filtroDTO,null);
	}
	...
	public List<FuncionarioDTO> consultarFuncionarioXFiltroYRol(
			FuncionarioDTO funcionarioDTO, RolDTO rolDTO) throws NSJPNegocioException {
		return consultarFuncionarioPorFiltro.consultarFuncionarioPorFiltro(funcionarioDTO,rolDTO.getRolId());
	}
