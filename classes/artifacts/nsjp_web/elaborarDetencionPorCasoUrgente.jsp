...
<title>Elaborar Detención Por Caso Urgente</title>
  ...
  <tr>
    ...
    <td width="197"><input type="text" id="nombre" onkeyup="habilitaBoton()" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
  ...
  <tr>
    ...
    <td width="179" align="left"><input type="text" id="delitos" onkeyup="habilitaBoton()" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" id="aMaterno" onkeyup="habilitaBoton()" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
  ...
  <tr>
    ...
    <td colspan="4" align="center"><strong>Nombre completo de quien autoriza:
      ...
      <input type="text" id="nombreQuienAutoriza" size="30" onkeyup="habilitaBoton()"onkeypress="return soloLetrasNPunto(event,this.id);"/>
    </strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
