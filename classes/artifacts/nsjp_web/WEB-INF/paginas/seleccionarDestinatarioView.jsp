...
<div id="usuarioExterno" style="display: none">
  ...
  <tr>
    ...
    <td width="196" align="left"><input type="text" name="nombreDestinatarioExt" id="nombreDestinatarioExt" size="30" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td align="left">Cargo:&nbsp;
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="apPatDestinatarioExt" id="apPatDestinatarioExt" size="30" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="apMatDestinatarioExt" id="apMatDestinatarioExt" size="30" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
