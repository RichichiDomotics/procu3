	...
	*/
	function mediosPruebaAsociados(){
		...
		jQuery("#gridMedioPruebaAsociadoAlDatoPJENS").jqGrid({ 
			...
			url:'<%=request.getContextPath()%>/consultarMediosPruebaAsociadosXDatoPrueba.do?audienciaId='+audienciaId+'&idDatoPrueba='+idDatoPrueba+'&numeroExpediente='+numeroExpediente+'',
			datatype: "xml", 
