...
<script type="text/javascript">
			...
			success: function(xml){
				...
				$(xml).find('tipoSolicitud').each(function(){
					...
					if( tipoSol == <%=TiposSolicitudes.AUDIENCIA.getValorId()%> ||
						...
						|| tipoSol == <%=TiposSolicitudes.ADJUNTAR_DOCUMENTO.getValorId()%> //enable IT cambio agregando actuacion
					){
	...
	*/	
	function muestraControles(tipoSolicitud){
		...
		/*Enable IT agregando anexar documento*/
		if(tipoSolicitud ==  <%=TiposSolicitudes.ADJUNTAR_DOCUMENTO.getValorId()%>){
			habilitaBotones();
			muestraCamposAudioVideoTranscripcion();			
		}
