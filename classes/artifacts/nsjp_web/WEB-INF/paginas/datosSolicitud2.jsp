...
<tr><td colspan="4">
  ...
  <tr>
	...
	<td align="right">Nombre(s):</td>
		<td class="field">
			<input type="text" tabindex="1" class="" size="50" maxlength="50" id="nombreDEATT1" name="nombreDEATT1"  value="" onkeydown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onkeyup="espejoDatos();" />
		</td>
	...
	<td align="right">Apellido Paterno:</td>
		<td>
			<input type="text" tabindex="2" size="50" maxlength="50" class="" id="aPaternoDEATT1" name="aPaternoDEATT1" onkeydown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onkeyup="espejoDatos();"/>
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" tabindex="3" size="50" maxlength="50" class="" id="aMaternoDEATT1"  name="aMaternoDEATT1" onkeydown="espejoDatos();" onkeypress="return soloLetrasNPunto(event,this.id);" onkeyup="espejoDatos();"/>
		</td>
	</tr>
	<tr>
