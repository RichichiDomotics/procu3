...
<head>
	  	...
	  	$("#divCambiarEtapa").dialog({ autoOpen: true, 
			modal: true, 
		  	...
		  	buttons:{"Cambiar":function() {
			  		confirmar=confirm("¿Se cambiará el estatus actual del expediente, ¿está seguro?");
			  		if (confirmar){
	...
	*/
	...
	function enviarSolicitudAudiencia(){
        ...
        $.updateWindowContent("iframewindowSolicitarAudiencia",'<iframe src="<%= request.getContextPath() %>/solicitarAudienciaMich.jsp'+params+'"    width="750" height="570" />');		
	}
		...
		<div id="tabsconsultaprincipal-2" style="display: none;" align="center">		
			...
			<div id="tabsconsultaprincipal-9">
				  ...
				  <tr>
				    ...
				    <td><input type="button" value="Cambiar estatus del expediente" id="cambiarEtapaDelExpediente" onClick="cambiarEtapaExpediente();" class="btn_Generico"/></td>
				  </tr>
				  <tr>
				    <td>&nbsp;</td>
				    <td>&nbsp;</td>
