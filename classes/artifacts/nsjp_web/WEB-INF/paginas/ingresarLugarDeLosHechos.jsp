			...
			<fieldset>
				...
				<table width="100%">
					...
					<tr>
						...
						<td><input name="text" type="text" id="solicitanteNombre" onkeypress="return soloLetrasDos(event);" size="50" maxlength="50" /></td>
					</tr>
					<tr>
						<td align="right">Apellido paterno:</td>
						<td><input name="text2" type="text" class="" id="solicitanteAPaterno" onkeypress="return soloLetrasDos(event);" size="50" maxlength="50" /></td>
					</tr>
					<tr>
						<td align="right">Apellido materno:</td>
						<td><input name="text3" type="text" class="" id="solicitanteAMaterno"  onkeypress="return soloLetrasDos(event);" size="50" maxlength="50"/></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td>&nbsp;</td>
