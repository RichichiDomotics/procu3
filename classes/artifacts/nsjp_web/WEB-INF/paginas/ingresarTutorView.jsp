						...
						<td>
							<table  bgcolor="#FFFFFF" width="30%" height="143" border="0" cellpadding="0"  cellspacing="0" class="celda2">
		                        ...
		                        <tr>
		                          ...
		                          <td width="29%"><input name="nombre" title="Escribir nombre" type="text" size="40" id="nombProResponsable"  style="background:#DDD" readonly="readonly" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
		                        </tr>
		                        <tr>
		                          <td width="32%" height="28">Apellido Paterno:</td>
		                          <td width="29%" height="28"><input name="aPaterno" title="Escribir apellido paterno" type="text" size="40" id="apPatProbResponsable" style="background:#DDD" readonly="readonly" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
		                        </tr>
		                        <tr>
		                          <td width="32%"  height="35">Apellido Materno:</td>
		                        <td height="35"><input name="aMaterno" title="Escribir apellido materno" type="text" size="40" id="apMatProbResponsable" style="background:#DDD" readonly="readonly" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
		                        </tr>
		                        <tr>
