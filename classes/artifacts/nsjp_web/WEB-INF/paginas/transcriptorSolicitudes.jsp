...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	function generarDocumentoView() {
		//Enable IT: REQ 82
		var actividad = <%=Actividades.SOLICITAR_TRANSCRIPCION_DE_AUDIENCIA.getValorId() %>;
	    ...
	    '<iframe src="<%=request.getContextPath()%>/generarDocumentoSinCaso.do?documentoId='+solicitudId+'&numeroUnicoExpediente='+numeroExpediente+'&nuevaActividad='+actividad+'" width="1140" height="400" />');
