			...
			<!--Comienza tabla con datos de la solicitud-->
				 ...
				 <tr>
			      ...
			      <tr>
			        ...
			        <td>
			            <input type="text" id="nombreSolicitantePJATP" style="width: 200px;" onkeypress="return soloLetrasNPunto(event,this.id);"/>
			        </td>
			      ...
			      <tr>
			        ...
			        <td>
			            <input type="text" id="apPatSolicitantePJATP" style="width: 200px;" onkeypress="return soloLetrasNPunto(event,this.id);"/>
			        </td>
			      </tr>
			      <tr>
			        <td colspan="2">&nbsp;</td>
			        ...
			        <td>
			            <input type="text" id="apMatSolicitantePJATP" style="width: 200px;" onkeypress="return soloLetrasNPunto(event,this.id);"/>
			        </td>
			      </tr>
			    </table>
