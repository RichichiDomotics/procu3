				...
				<div id="tabsconsultaprincipal-1">
					<table border="0" width="100%">
						<tr>
							...
							<td>
								<input type="text" size="50" maxlength="50" id="datosGeneralesCmpApaterno" onkeypress="return soloLetrasNPunto(event,this.id);"/>
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" size="50" maxlength="50" id="datosGeneralesCmpMaterno" onkeypress="return soloLetrasNPunto(event,this.id);"/>
							</td>
						</tr>
						<tr>
							<td align="right">Nombre(s):</td>
							<td>
								<input type="text" size="50" maxlength="50" id="datosGeneralesCmpNombres" onkeypress="return soloLetrasNPunto(event,this.id);"/>
							</td>
						</tr>
						<tr>
