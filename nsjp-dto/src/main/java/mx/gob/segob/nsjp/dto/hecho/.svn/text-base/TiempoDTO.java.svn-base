...
public class TiempoDTO extends GenericDTO {
    ...
    /**Enable GB*/
    private String strHoraInicio,strFechaInicio,strHoraFin,strFechaFin;
    ...
    */
	...
	public void setFechaInicio(Date fechaInicio) {
		...
		/********ENABLE*****/
		this.strHoraInicio= DateUtils.formatearHoraAm(fechaInicio);
		this.strFechaInicio= DateUtils.formatear(fechaInicio);
	}
	/************************ENABLE************************/
...
/****************************************************/
	...
	public void setFechaFin(Date fechaFin) {
		...
		/***************Enable GB********************************/
		this.strHoraFin= DateUtils.formatearHoraAm(fechaFin);
		this.strFechaFin= DateUtils.formatear(fechaFin);
	}
