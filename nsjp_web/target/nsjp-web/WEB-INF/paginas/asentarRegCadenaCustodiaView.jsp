...
<!--    Hoja de estilo para easyaccordion-->
    ...
    <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/resources/css/ui-lightness/jquery-ui-1.8.11.custom.css" />
      ...
      <script type="text/javascript">
		...
		/*variables para validar fechas/*Enable IT ByYolo*/
		var esValidoFecha=0;
		var esValidoHora=0;
		var validarHora=0;
		...
		$(document).ready(function() {
			...
			/*se se validan que la fechas sean consecutivas en tiempo/*Enable IT ByYolo*/
// 			$('#txtCadCusFechaEntrega').change(validaFechaEntrega);
// 			$('#txtCadCusFechaTraslado').change(validaFechaTraslado);
// 			$('#txtCadCusFechaRecepcion').change(validaFechaRecepcion);	
			
// 			$('#txtCadCusHoraEntrega').blur(validaFechaEntrega);
// 			$('#txtCadCusHoraTraslado').blur(validaFechaTraslado);
// 			$('#txtCadCusHoraRecepcion').blur(validaFechaRecepcion);

			$('#txtCadCusFechaEntrega').change(validaTodasLasFechas);
			$('#txtCadCusFechaTraslado').change(validaTodasLasFechas);
			$('#txtCadCusFechaRecepcion').change(validaTodasLasFechas);	
			
			$('#txtCadCusHoraEntrega').blur(validaTodasLasFechas);
			$('#txtCadCusHoraTraslado').blur(validaTodasLasFechas);
			$('#txtCadCusHoraRecepcion').blur(validaTodasLasFechas);
...
// 					}	
			...
			if(parseInt(consultaCadena)==1)
			{
				...
				$("#btnCapturarEvidenciaCadCus").show();
				$("#btnSeleccionaEvidenciaCadCus").hide();
	     ...
	     function cargaCatalogoTipoEslabon()
	     {
			...
			*/
			function limpiaCamposEslabonCadCus()
			{
				...
				$("#txtHoraEntregaEslbn").timeEntry({show24Hours: false,defaultTime: "07:00 AM",maxTime: null});
				...
				$("#txtHoraRecepcionEslbn").timeEntry({show24Hours: false,defaultTime: "07:00 AM",maxTime: null});
				
				$("#txtFechaPrestamoEslbn").val("");
				$("#txtHoraPrestamoEslbn").timeEntry('destroy');
				$("#txtHoraPrestamoEslbn").timeEntry({show24Hours: false,defaultTime: "07:00 AM",maxTime: null});
				
				$("#txtHoraPrestamoRepEslbn").timeEntry('destroy');
				$("#txtHoraPrestamoRepEslbn").timeEntry({show24Hours: false,defaultTime: "07:00 AM",maxTime: null});
...
<%-- 								   $(this).find('clave').text()!=<%= Objetos.OTRO.getValorId() %> && --%>
			...
			/*Se validan las fehcas para que siga un flujo continuo/*Enable IT ByYolo*/
			function comparafechas(fechaInicio, fechaFin){
				...
				var anoInicio=fechaInicio.substr(6,4);
				var anoFin=fechaFin.substr(6,4);
				
// 				alert('Fecha inicio: '+diaInicio+'/'+mesInicio+'/'+anoInicio+'   Fecha Fin: '+diaFin+'/'+mesFin+'/'+anoFin);
				
				if(fechaInicio!=null && fechaInicio!="undefined" &&fechaInicio!='' ){
					if(diaInicio<=diaFin && mesInicio<=mesFin && anoInicio<=anoFin){
// 						alert ('Fecha igual');	
						esValidoFecha=1;
			...
			//obtiene el horario ya sea AM o PM
			function obtenHorario(hora){
				
				var horario='';
				horario=hora.search("AM");
				
				if(horario!='' && horario!=null && horario!=-1 && horario!="-1"){
					horario=hora.substr(horario,2);					
				}else{
					horario=hora.search("PM");
					
					if(horario!='' && horario!=null && horario!=-1 && horario!="-1"){
						horario=hora.substr(horario,2);
// 						alert("horario despues de funcion:	"+horario);
					}
				}
				return horario;
			}
			...
			//compara horas
			function comparaHoras(horaInicio, horaFin){
				
				var horarioInicio='';
				var horarioFin='';
				
				if(horaInicio!=null && horaInicio!="undefined" && horaInicio!='' && horaInicio!= "null"
					&& horaFin!=null && horaFin!="undefined" && horaFin!='' && horaFin!= "null"){
					
					/*solo se obtine la parte de AM y PM/*Enable IT ByYolo*/
					horarioInicio=obtenHorario(horaInicio);
					horarioFin=obtenHorario(horaFin);
					...
					if(horarioInicio!=horarioFin){
						...
						var posicionPuntosHoraInicio=horaInicio.search(":")
						var posicionPuntosHoraFin=horaFin.search(":");
						
						var hInicio=horaInicio.substr(0,posicionPuntosHoraInicio);
						var mInicio =horaInicio.substr((posicionPuntosHoraInicio+1),2);
						var hFin=horaFin.substr(0,posicionPuntosHoraFin);
						var mFin=horaFin.substr((posicionPuntosHoraFin+1),2);
			...
			function validaFechasVacias(fechaInicio, fechaFin, horaInicio, horaFin){
				
				if(fechaInicio!=null && fechaInicio!="undefined" && fechaInicio!='' &&
					fechaFin!=null && fechaFin!="undefined" && fechaFin!='' &&
						horaInicio!=null && horaInicio!="undefined" && horaInicio!='' &&
							horaFin!=null && horaFin!="undefined" && horaFin!=''){
					return true;	
				}else{
					return false;	
				}				
			...
			function validaFechaEntrega(){
				...
				var fechaTempInicio = $('#txtCadCusFechaEntrega').val();
				var horaTempInicio = $('#txtCadCusHoraEntrega').val();
				var fechaTempFin = $('#txtCadCusFechaTraslado').val();
				var horaTempfin = $('#txtCadCusHoraTraslado').val();
					
				var notNull=validaFechasVacias(fechaTempInicio, horaTempInicio, fechaTempFin, horaTempfin);
				
				if(notNull){
					comparafechas($('#txtCadCusFechaEntrega').val(),$('#txtCadCusFechaTraslado').val());
					
					if(esValidoFecha===0){
						alert('La fecha de traslado debe de ser mayor a la fecha de levantamiento.');
						$('#txtCadCusFechaTraslado').val('');
						$('#txtCadCusFechaRecepcion').val('');
					}else if (validarHora===1){
						comparaHoras($('#txtCadCusHoraEntrega').val(),$('#txtCadCusHoraTraslado').val());
						
						if(esValidoHora===0){
							alert('La hora de traslado debe de ser mayor a la hora de levantamiento.');
							$('#txtCadCusFechaTraslado').val('');
							$('#txtCadCusFechaRecepcion').val('');
						}
			...
			function validaFechaRecepcion(){
				...
				var fechaTempInicio = $('#txtCadCusFechaTraslado').val();
				var horaTempInicio = $('#txtCadCusHoraTraslado').val();
				var fechaTempFin = $('#txtCadCusFechaRecepcion').val();
				var horaTempfin = $('#txtCadCusHoraRecepcion').val();
					
				var notNull=validaFechasVacias(fechaTempInicio, horaTempInicio, fechaTempFin, horaTempfin);
				
				if(notNull){
					comparafechas($('#txtCadCusFechaTraslado').val(),$('#txtCadCusFechaRecepcion').val());
					
					if(esValidoFecha===0){
						alert('La fecha de recepción debe de ser mayor a la fecha de traslado.');
						$('#txtCadCusFechaRecepcion').val('');	
					}else if (validarHora===1){
						comparaHoras($('#txtCadCusHoraTraslado').val(),$('#txtCadCusHoraRecepcion').val());
						
						if(esValidoHora===0){
							alert('La hora de recepción debe de ser mayor a la hora de traslado.');
							$('#txtCadCusFechaRecepcion').val('');	
						}
			...
			function validaTodasLasFechas(){
				validaFechaEntrega();
				validaFechaTraslado();
				validaFechaRecepcion();
			}
...
<!--      				<input type="radio" value="0" id="rdbCadCusRespTrasInt" name="rdbCadCusRespTras" class="rdbCadCusRespTras"/>Interno &nbsp;&nbsp;&nbsp;
        			...
        			<td align="left">Hora de levantamiento: <input type="text" id="txtCadCusHoraEntrega" class="timeRange" value="07:00 AM" size="10"/>
        			</td>
        		</tr>
        		<tr>
        			<td>
...
<!--       				<input type="radio" value="0" id="rdbCadCusPerEntInt" name="rdbCadCusPerEnt" class="rdbCadCusPerEnt"/>Interno &nbsp;&nbsp;&nbsp;
        			...
        			<td>Hora de inicio de traslado: <input type="text" id="txtCadCusHoraTraslado" class="timeRange" value="07:30 AM" size="10"/>
        			</td>        			
        		</tr>
        		<tr>
        			<td>
        		...
        		<tr>
        			...
        			<td>Hora de recepci&oacute;n: <input type="text" id="txtCadCusHoraRecepcion" class="timeRange" value="07:00 AM" size="10"/>
        			</td>
        		</tr>
        	</table>        
        	...
        	<table width="100%" cellpadding="2" class="tablaConsulta" border="0">
        		...
        		<tr align="center">
        			...
        			<td align="left">Hora de entrega: <input type="text" disabled="disabled" id="txtCadCusHoraEntregaC" class="timeRange" value="o7:00 AM" size="10"/>
        			</td>
        		</tr>
        		<tr>
        			<td>
        		...
        		<tr>
        			...
        			<td>Hora de traslado: <input type="text" id="txtCadCusHoraTrasladoC" disabled="disabled" class="timeRange" value="07:00 AM" size="10"/>
        		</tr>
        		<tr>
        			<td>
        				<table width="100%" border="0">
        		...
        		<tr>
        			...
        			<td>Hora de recepci&oacute;n: <input type="text" id="txtCadCusHoraRecepcionC" disabled="disabled" class="timeRange" value="07:00 AM" size="10"/>
        			</td>
        		</tr>
        	</table> 
        	...
        	<table width="850px">
        		...
        		<tr class="trCapturaEvidenciaCadCus tablaInsercion">
        			<td>
						...
						Hora de levantamiento:  <input type="text" id="txtAddCadCusHoraLev" class="timeRange" value="07:00 AM" size="10"/><br/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        		...
        		<tr class="trSeleccionaEvidenciaCadCus tablaInsercion">
        			<td><br/>
						...
						Hora de levantamiento:  <input type="text" id="txtAddCadCusHoraLevReg" class="timeRange" value="07:00 AM" size="10"/>
						&nbsp;&nbsp;
        			...
        			<td>
        				<table width="50%">
        					...
        					<tr>
        						...
        						<td>
        							<input type="text" id="txtHoraEntregaEslbn" class="timeRange" value="07:00 AM" size="10"/>
        						</td>
        					</tr>
        					<tr>
        						<td>
        					...
        					<tr>
        						...
        						<td>
        							<input type="text" id="txtHoraPrestamoEslbn" class="timeRange" value="07:00 AM" size="10"/>
        						</td>
        					</tr>
        			...
        			<td>
        				<table width="50%">
        					...
        					<tr>
        						...
        						<td>
        							<input type="text" id="txtHoraRecepcionEslbn" class="timeRange" value="07:00 AM" size="10"/>
        						</td>
        					</tr>
        					<tr>
        						<td>
        					...
        					<tr>
        						...
        						<td>
        							<input type="text" id="txtHoraPrestamoRepEslbn" class="timeRange" value="07:00 AM" size="10"/>
        						</td>
        					</tr>
