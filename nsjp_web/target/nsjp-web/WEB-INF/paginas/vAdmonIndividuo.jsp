...
<table width="734" border="0" align="center" id="tdatospersonales">
    ...
    <td width="120"><input type = "text" name = "nombre12" size = "20" id=nombre onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td width="122">Apellido paterno:</td>
    <td width="120"><input type = "text" name = "nombre13" size = "20" id=apPaterno onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    <td width="122">Apellido materno:</td>
    <td width="120"><input type = "text" name = "nombre14" size = "20" id=apMaterno onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
  </tr>
  <tr>
    <td>Edad: </td>
