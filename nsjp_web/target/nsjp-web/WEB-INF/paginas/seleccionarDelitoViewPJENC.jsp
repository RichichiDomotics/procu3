    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
			...
			jQuery("#gridCatDelitos").jqGrid({ 
				...
				datatype: "xml", 
				colNames:['Clave','Delito', '¿Prisión P. O.?','¿Prisión P. O.?','Delito Principal','Tipo','DelitoId'], 
...
<body>
	<table border="0"  width="1500px">
		<tr>
			...
			<td  align="left"><input type="button" id="btnGuardarDelitosAg" value="Guardar" onclick="guardarDelitosAgraviadosExp();" class="btn_Generico"/>
