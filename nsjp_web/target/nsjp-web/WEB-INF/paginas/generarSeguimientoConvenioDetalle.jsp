	...
	function consultarDetalleConvenio(){
		...
		$.ajax({
			...
			success: function(xml){
				...
				$("#cbxVictima").val($(xml).find('convenioDTO').find('involucradoVictima').find('nombresDemograficoDTO').find('nombre').first().text()+" "+$(xml).find('convenioDTO').find('involucradoVictima').find('nombresDemograficoDTO').find('apellidoPaterno').first().text()+" "+$(xml).find('convenioDTO').find('involucradoVictima').find('nombresDemograficoDTO').find('apellidoMaterno').first().text());
