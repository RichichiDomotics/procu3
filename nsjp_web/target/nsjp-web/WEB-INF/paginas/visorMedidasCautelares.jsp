...
/*******************************************************COMIENZA FUNCIONALIDAD PARA ACTUACIONES PERICIALES ***************************************************/
	...
	*/
	...
	function abrirDocumento(documentoId,numUnicoExp){
	    ...
	    $.updateWindowContent("iframewindowGenerarDocumentoPericial"+idWindowGenerarDictamenInforme,"<iframe src='<%= request.getContextPath() %>/generarDocumentoSinCaso.do?documentoId="+documentoId+"&numeroUnicoExpediente="+numUnicoExp+"&medidaCautelarId="+medidaId+"&nuevoEstatusMedidaCautelar="+estatusNuevo+"&esDocumentoDeMedidaCautelar="+esDocumentoDeMedidaCautelar+"' width='1140' height='400' />");
