				...
				<td>
					<table width="400" border="0" cellspacing="5" cellpadding="0">
				      <tr>
				        ...
				        <td width="70%"><input type="text" id="txtNombre" style="width: 100%;" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
				      </tr>
				      <tr>
				      	<td width="30%" >Apellido Paterno: </td>
				        <td width="70%"><input type="text" id="txtApPaterno" style="width: 100%;" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
				      </tr>
				      <tr>
				      	<td width="30%" >Apellido Materno: </td>
				        <td width="70%"><input type="text" id="txtApMaterno" style="width: 100%;" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
				      </tr>
				       <tr>
