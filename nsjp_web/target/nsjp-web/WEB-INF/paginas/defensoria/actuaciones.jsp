...
<table width="820" border="0" cellspacing="0" cellpadding="0" >
	...
	<tr>
		...
		<td><table id="tblActuacionesEnvioSol" style="display: none;">
				<tr>
			...
			<table id="tblActuacionesCambioEst" style="display: none;">
				<tr>
					<td id="tdCbxAccionesTabEstatus"><select size="20" id="cbxAccionesTabEstatus" style="width:470px"></select></td>
				</tr>
			</table>
		</td>
			...
			<table>
				<tr>
					<td>
						<input type="button" value="Cambiar estatus del expediente" id="cambiarEtapaDelExpediente" onClick="cambiarEtapaExpediente();" class="btn_grande"/>					
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						...
						<input type="button" value="Medidas Cautelares" id="btnMedidasCautelares" onClick="funcionalidadNoDisponible();" class="btn_grande"/>
					</td>
				</tr>				
			</table>
		</td>
...
<div id="divCambiarEtapa" style="display: none">
	<table align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td>&nbsp;</td>
		    <td align="center"><strong>El estatus actual del expediente es:
		  ...
		  <tr>
		    <td>&nbsp;</td>
		    <td align="center"><strong>Nuevo estatus:
