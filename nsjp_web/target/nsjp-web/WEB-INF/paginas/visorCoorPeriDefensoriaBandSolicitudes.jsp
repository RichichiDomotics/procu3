    ...
    <div id="tabsconsultaprincipal-1" style="height: 400">
	  	...
	  	<div id="divNombre">
	  		<table>
	  			<tr>
	  				<td>Nombre(s): </td>
	  				<td><input type="text" id="txtNombre" style="width:200px;" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
	  			</tr>
	  			<tr>
	  				<td>Apellido Paterno: </td>
	  				<td><input type="text" id="txtApPaterno" style="width:200px;" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
	  			</tr>
	  			<tr>
	  				<td>Apellido Materno: </td>
	  				<td><input type="text" id="txtApMaterno" style="width:200px;" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
	  			</tr>
	  		</table>
	  	</div>
