									...
									<td width="32%" height="130" align="center" valign="top" >
									  <table  style="background:#DDD;border: 0;" width="30%" height="143" cellpadding="0"  cellspacing="0" class="celda2">
							                ...
							                <tr>
							                  ...
							                  <td width="29%"><input name="nombre" title="Escribir nombre" type="text" size="40" id="nombContactoOrg" style="background:#DDD;border: 0;" readonly="readonly" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
							                </tr>
							                <tr>
							                  <td width="32%" height="28">Apellido Paterno:</td>
							                  <td width="29%" height="28"><input name="aPaterno" title="Escribir apellido paterno" type="text" size="40" style="background:#DDD;border: 0;" id="apPatContactoOrg" readonly="readonly" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
							                </tr>
							                <tr>
							                  <td width="32%"  height="35">Apellido Materno:</td>
							                <td height="35"><input name="aMaterno" title="Escribir apellido materno" type="text" size="40" id="apMatContactoOrg" style="background:#DDD;border: 0;" readonly="readonly" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
							                </tr>
							                <tr>
