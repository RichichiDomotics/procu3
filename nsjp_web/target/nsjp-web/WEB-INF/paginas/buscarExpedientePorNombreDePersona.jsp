							...
							if (reloadGridNombre) {																
								  ...
								  jQuery("#tablaBuscarExpedientePorNombreDePersona").jqGrid(
											{ url:'<%= request.getContextPath() %>/buscarExpedientePorNombreDePersona.do', 						
												...
												colNames:['No. Caso','Expediente','Nombre','A. Paterno','A. Materno','Calidad','involucradoId'], 
												colModel:[ {name:'caso', index:'caso',width:125, sortable:false},
															...
															{name:'involucradoId',index:'involucradoId', width:50, sortable:false, hidden:true} 
															], 
													autowidth: true, 
													...
													onSelectRow: function(id){
														...
														/*se cambia funcion/*Enable It ByYolo*/
														detEviInvo(id, numExp,ret.involucradoId);
//														detEvi(id, numExp);
													},
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="13" align="center"><input type="text" name="nombre" id="nombre" size="40" maxlength="50" onkeypress="return soloLetrasNPunto(event,this.id);"/></td>
    </tr>
  <tr>
  ...
  <tr id="nombreApellido">
    <td height="25" align="center">&nbsp;
      <input type="text" name="apellido" id="apellido" size="40" maxlength="50" onkeypress="return soloLetrasNPunto(event,this.id);"/>      &nbsp;</td>
    </tr>
  <tr>
  ...
  <tr id="nombreApellidoMat">
    <td height="25" align="center">&nbsp;
      <input type="text" name="apellidoMat" id="apellidoMat" size="40" maxlength="50" onkeypress="return soloLetrasNPunto(event,this.id);"/>      &nbsp;</td>
    </tr>
