		...
		<div id="tabsconsultaprincipal-1">
		    <table border="0" width="100%">
				<tr>
					...
					<td>
						<input type="text" class="" style="width: 180px;" maxlength="30" id="datosGeneralesCmpNombres" disabled="disabled" onkeypress="return soloLetrasNPunto(event,this.id);"/>
					</td>
					<td align="right">*Apellido Paterno:</td>
					<td>
						<input type="text" style="width: 180px;" maxlength="30" class="" id="datosGeneralesCmpApaterno" disabled="disabled" onkeypress="return soloLetrasN(event,this.id);"/>
					</td>
					<td align="right">*Apellido Materno:</td>
					<td>
						<input type="text" style="width: 180px;" maxlength="30" class="" id="datosGeneralesCmpMaterno" disabled="disabled" onkeypress="return soloLetrasN(event,this.id);"/>
					</td>
				</tr>
				<tr>
