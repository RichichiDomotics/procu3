					...
					<table width="100%" cellspacing="0" cellpadding="0" align="center">
						...
						<tr>
							...
							<td width="72%"><strong> <input type="text"
									size="30" id="nombreMediador" onkeypress="return soloLetrasNPunto(event,this.id);"/> </strong>
							</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
							...
							<td><strong> <input type="text" size="30"
									id="nombreMediador2" onkeypress="return soloLetrasNPunto(event,this.id);"/> </strong>
							</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
							...
							<td><strong> <input type="text" size="30"
									id="nombreMediador3" onkeypress="return soloLetrasNPunto(event,this.id);"/> </strong>
							</td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
