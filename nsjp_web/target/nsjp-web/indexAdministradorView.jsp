...
<script type="text/javascript">
	...
	*/
	...
	function ventanaBitacoraIAM(){
		...
		$.newWindow({id:"iframewindowBitacoraIAM", statusBar: true, posx:200,posy:50,width:1070,height:570,title:"Consultar bitácora IAM", type:"iframe"});
	    $.updateWindowContent("iframewindowBitacoraIAM",'<iframe src="<%=request.getContextPath()%>/bitacoraConsultaIAM.do" width="1070" height="570" />'); 
	...
	*/
	...
	function generaVisorReporteView() {
		$.newWindow({id:"iframewindowWindowImageViewer", statusBar: true, posx:85,posy:86,width:1120,height:499,title:"Tablero de Control", type:"iframe"});
	    $.updateWindowContent("iframewindowWindowImageViewer",'<iframe src="<%=request.getContextPath()%>/visorReportesAdmin.do" width="1140" height="499" />');	    		
	}
	...
	<div class="ui-layout-west">
		...
		<div class="content">
			<div id="accordionmenuprincipal">
				...
				<!-- eNABLE IT: Se ocultan pestañas para las bitacoras -->
			...
			<!--	comienza tab Tablero de Control -->
				<h3><a id="reportes" href="#"><img src="<%=request.getContextPath() %>/resources/images/icn_carpprincipal.png" id="botpenal" width="15" height="15">&nbsp;Tablero de Control</a></h3>
			<!--	termina tab Tablero de Control -->
			</div>
		</div>
	</div>
	<!--Fin ui-layout-west-->
