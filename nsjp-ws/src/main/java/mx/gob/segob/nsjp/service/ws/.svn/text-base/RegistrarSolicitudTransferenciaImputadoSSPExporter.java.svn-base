/**
* Nombre del Programa : RegistrarSolicitudTransferenciaImputadoSSPExporter.java
* Autor                            : cesarAgustin
* Compania                    : Ultrasist
 ...
 */
@WebService
public interface RegistrarSolicitudTransferenciaImputadoSSPExporter extends
